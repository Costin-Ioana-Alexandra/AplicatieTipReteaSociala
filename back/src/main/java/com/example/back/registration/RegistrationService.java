...
public class RegistrationService {
  ...
  public String register(final RegistrationRequest request) {
    ...
    String token = appUserService
        .signUpUser(new AppUser(request.getFirstName(), request.getLastName(),
...
//        }
    ...
    return "<div style=\"font-family:Helvetica,Arial,sans-serif;" +
        ...
        + "line-height:1.315789474;Margin-top:4px;padding-left:10px\">\n"
        + "                      <span style=\"font-family:Helvetica,Arial,sans-serif;"
        + "font-weight:700;color:#ffffff;text-decoration:none;"
        + "vertical-align:top;display:inline-block\">"
        + "Congratulations, you have confirmed your account!</span>\n"
        + "                    </td>\n" + "                  </tr>\n"
        + "                </tbody></table>\n" + "              </a>\n"
        + "            </td>\n" + "          </tr>\n"
        + "        </tbody></table>\n" + "        \n" + "      </td>\n"
        ...
        + "color:#0b0c0c\">Good work! </p><p style=\"Margin:0 0 20px 0;"
        + "font-size:19px;line-height:25px;color:#0b0c0c\"> "
        + "Thank you for registering. You are the best! \n "
  ...
  private String buildEmail(final String name, final String link) {
    return "<div style=\"font-family:Helvetica,Arial,sans-serif;" +
        ...
        + "            <p style=\"Margin:0 0 20px 0;font-size:19px;" +
            "line-height:25px;color:#0b0c0c\">Hi "
        + name
        + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;" +
            ...
            "<p style=\"Margin:0 0 20px 0;font-size:19px;" +
            "line-height:25px;color:#0b0c0c\"> <a href=\""
        + link
